// Generated by gencpp from file messages/Injury_report_response.msg
// DO NOT EDIT!


#ifndef MESSAGES_MESSAGE_INJURY_REPORT_RESPONSE_H
#define MESSAGES_MESSAGE_INJURY_REPORT_RESPONSE_H
...
struct Injury_report_response_
{
  typedef Injury_report_response_<ContainerAllocator> Type;

  Injury_report_response_()
    : run()
    , team()
    , user()
    , system()
  ...
  Injury_report_response_(const ContainerAllocator& _alloc)
    : run(_alloc)
    , team(_alloc)
    , user(_alloc)
    , system(_alloc)
  ...
  typedef boost::shared_ptr< ::messages::Injury_report_response_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::messages::Injury_report_response_<ContainerAllocator> const> ConstPtr;

}; // struct Injury_report_response_

typedef ::messages::Injury_report_response_<std::allocator<void> > Injury_report_response;

typedef boost::shared_ptr< ::messages::Injury_report_response > Injury_report_responsePtr;
typedef boost::shared_ptr< ::messages::Injury_report_response const> Injury_report_responseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::messages::Injury_report_response_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::messages::Injury_report_response_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::messages::Injury_report_response_<ContainerAllocator1> & lhs, const ::messages::Injury_report_response_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::messages::Injury_report_response_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::messages::Injury_report_response_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::messages::Injury_report_response_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::messages::Injury_report_response_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::messages::Injury_report_response_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::messages::Injury_report_response_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::messages::Injury_report_response_<ContainerAllocator> >
{
  ...
  static const char* value(const ::messages::Injury_report_response_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5c653f4ac768e45eULL;
  static const uint64_t static_value2 = 0xb2a569cb157fdb44ULL;
};

template<class ContainerAllocator>
struct DataType< ::messages::Injury_report_response_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::messages::Injury_report_response_<ContainerAllocator> >
{
  static const char* value()
  {
    return "string  run\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::messages::Injury_report_response_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::messages::Injury_report_response_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::messages::Injury_report_response_<ContainerAllocator>& v)
  {
    s << indent << "run: ";
...
#endif // MESSAGES_MESSAGE_INJURY_REPORT_RESPONSE_H
