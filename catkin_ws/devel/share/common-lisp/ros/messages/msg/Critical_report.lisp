...
(cl:defclass <Critical_report> (roslisp-msg-protocol:ros-message)
  ((casualty_id
    :reader casualty_id
    :initarg :casualty_id
    :type cl:integer
...
(cl:defclass Critical_report (<Critical_report>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Critical_report>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Critical_report)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages-msg:<Critical_report> is deprecated: use messages-msg:Critical_report instead.")))

(cl:ensure-generic-function 'casualty_id-val :lambda-list '(m))
(cl:defmethod casualty_id-val ((m <Critical_report>))
...
(cl:defmethod team-val ((m <Critical_report>))
...
(cl:defmethod system-val ((m <Critical_report>))
...
(cl:defmethod type-val ((m <Critical_report>))
...
(cl:defmethod value-val ((m <Critical_report>))
  ...
  (value m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Critical_report>) ostream)
  "Serializes a message object of type '<Critical_report>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Critical_report>) istream)
  "Deserializes a message object of type '<Critical_report>"
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Critical_report>)))
  "Returns string type for a message object of type '<Critical_report>"
  "messages/Critical_report")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Critical_report)))
  "Returns string type for a message object of type 'Critical_report"
  "messages/Critical_report")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Critical_report>)))
  "Returns md5sum for a message object of type '<Critical_report>"
  "3ec9446ca1a98dc79ca9f3632cd565bd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Critical_report)))
  "Returns md5sum for a message object of type 'Critical_report"
  "3ec9446ca1a98dc79ca9f3632cd565bd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Critical_report>)))
  "Returns full string definition for message of type '<Critical_report>"
  (cl:format cl:nil "int32   casualty_id~%string  team~%string  system~%string  type~%int32   value~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Critical_report)))
  "Returns full string definition for message of type 'Critical_report"
  (cl:format cl:nil "int32   casualty_id~%string  team~%string  system~%string  type~%int32   value~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Critical_report>))
  (cl:+ 0
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Critical_report>))
  "Converts a ROS message object to a list"
  (cl:list 'Critical_report
