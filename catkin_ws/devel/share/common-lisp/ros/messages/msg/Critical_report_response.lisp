...
(cl:defclass <Critical_report_response> (roslisp-msg-protocol:ros-message)
  ((run
    :reader run
    :initarg :run
    :type cl:string
...
(cl:defclass Critical_report_response (<Critical_report_response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Critical_report_response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Critical_report_response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages-msg:<Critical_report_response> is deprecated: use messages-msg:Critical_report_response instead.")))

(cl:ensure-generic-function 'run-val :lambda-list '(m))
(cl:defmethod run-val ((m <Critical_report_response>))
...
(cl:defmethod team-val ((m <Critical_report_response>))
...
(cl:defmethod user-val ((m <Critical_report_response>))
...
(cl:defmethod system-val ((m <Critical_report_response>))
...
(cl:defmethod clock-val ((m <Critical_report_response>))
...
(cl:defmethod report_id-val ((m <Critical_report_response>))
...
(cl:defmethod report_timestamp-val ((m <Critical_report_response>))
...
(cl:defmethod reports_remaining-val ((m <Critical_report_response>))
...
(cl:defmethod report_status-val ((m <Critical_report_response>))
...
(cl:defmethod casualty_id-val ((m <Critical_report_response>))
...
(cl:defmethod type-val ((m <Critical_report_response>))
...
(cl:defmethod value-val ((m <Critical_report_response>))
  ...
  (value m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Critical_report_response>) ostream)
  "Serializes a message object of type '<Critical_report_response>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Critical_report_response>) istream)
  "Deserializes a message object of type '<Critical_report_response>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Critical_report_response>)))
  "Returns string type for a message object of type '<Critical_report_response>"
  "messages/Critical_report_response")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Critical_report_response)))
  "Returns string type for a message object of type 'Critical_report_response"
  "messages/Critical_report_response")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Critical_report_response>)))
  "Returns md5sum for a message object of type '<Critical_report_response>"
  "5c653f4ac768e45eb2a569cb157fdb44")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Critical_report_response)))
  "Returns md5sum for a message object of type 'Critical_report_response"
  "5c653f4ac768e45eb2a569cb157fdb44")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Critical_report_response>)))
  "Returns full string definition for message of type '<Critical_report_response>"
  (cl:format cl:nil "string  run~%string  team~%string  user~%string  system~%float64 clock~%string  report_id~%string  report_timestamp~%int32   reports_remaining~%string  report_status~%int32   casualty_id~%string  type~%int32   value~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Critical_report_response)))
  "Returns full string definition for message of type 'Critical_report_response"
  (cl:format cl:nil "string  run~%string  team~%string  user~%string  system~%float64 clock~%string  report_id~%string  report_timestamp~%int32   reports_remaining~%string  report_status~%int32   casualty_id~%string  type~%int32   value~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Critical_report_response>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Critical_report_response>))
  "Converts a ROS message object to a list"
  (cl:list 'Critical_report_response
    (cl:cons ':run (run msg))
