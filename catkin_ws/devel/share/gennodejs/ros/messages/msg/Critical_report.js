...
class Critical_report {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Critical_report(null);
  ...
  static datatype() {
    ...
    return 'messages/Critical_report';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Critical_report(null);
...
module.exports = Critical_report;
