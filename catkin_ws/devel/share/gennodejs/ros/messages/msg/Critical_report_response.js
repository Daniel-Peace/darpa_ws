...
class Critical_report_response {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Critical_report_response(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Critical_report_response(null);
...
module.exports = Critical_report_response;
