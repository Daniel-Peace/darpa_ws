...
class Injury_report_response {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Injury_report_response(null);
  ...
  static datatype() {
    ...
    return 'messages/Injury_report_response';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Injury_report_response(null);
...
module.exports = Injury_report_response;
